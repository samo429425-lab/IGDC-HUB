...
const VERSION = 'A1.5.45-595-sanmaru-cpu-cache-wide-category-page25';
...
function sourceCaps(opts){
  ...
  return {
    ...
    naverBlogPages: deep ? 5 : 3,
    naverNewsPages: deep ? 5 : 4,
    naverCafePages: deep ? 4 : 3,
    naverEncycPages: deep ? 1 : 1,
    naverKinPages: deep ? 1 : 1,
    naverBookPages: deep ? 2 : 1,
    naverLocalPages: 1,
    googlePages: deep ? 6 : 4,
    bingPages: deep ? 3 : 2,
    imagePages: deep ? 4 : 3,
    naverImagePages: deep ? 4 : 3,
    youtubeLimit: deep ? 100 : 60,
...
async function googleSnsSearch(q, limit, start){
  ...
  return {
    source: 'google_sns',
    results: results.slice(0, Math.min(limit || 20, 20)),
    meta: {
...
exports.handler = async function(event){
  try{
    ...
    let base = null;
    const sanmaruCanServeFromFastLayer = residentSeedPack && sanmaruFastLayerEnough(residentSeedPack, limit, raw || {}) && !forceProviderRefresh && !truthy(raw && (raw.forceWide || raw.waitProviders || raw.waitExternal));
