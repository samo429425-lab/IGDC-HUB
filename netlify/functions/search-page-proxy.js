...
function snapshotDocument(htmlText, finalUrl, opts){
...
function injectShell(htmlText, finalUrl, opts){
  ...
  if(mode === 'snapshot') return snapshotDocument(htmlText, finalUrl, opts);
  ...
  const headInject = [
    ...
    '<script>(function(){try{Object.defineProperty(window,"top",{get:function(){return window;}});}catch(e){}try{Object.defineProperty(window,"parent",{get:function(){return window;}});}catch(e){}try{window.open=function(u){try{parent.postMessage({__igdcProxyNavigate:1,proxyId:' + JSON.stringify(String(opts.proxyId||'')) + ',url:String(u||location.href)},"*");}catch(e){};return null;};}catch(e){}})();</script>',
