...
function isBlocked(item){
  ...
  if(item.platform && item.platform !== 'placeholder' && !SAFE_PLATFORMS.includes(item.platform)) return true;
...
function normalize(it, idx){
  ...
  return {
    ...
    platform: (typeof it.platform === 'string' ? it.platform : (it.source && typeof it.source === 'object' ? (it.source.platform || it.source.name || null) : (typeof it.source === 'string' ? it.source : null))) || null,
