...
(function(){
  ...
  var PRODUCT_SECTIONS=Object.freeze([
    {key:'home|home_1',page:'home',section:'home_1',label:'홈 · home_1'},{key:'home|home_2',page:'home',section:'home_2',label:'홈 · home_2'},{key:'home|home_3',page:'home',section:'home_3',label:'홈 · home_3'},{key:'home|home_4',page:'home',section:'home_4',label:'홈 · home_4'},{key:'home|home_5',page:'home',section:'home_5',label:'홈 · home_5'},{key:'home|home_right_middle',page:'home',section:'home_right_middle',label:'홈 · 우측 상단 (푸드·리빙·책방)'},{key:'home|home_right_bottom',page:'home',section:'home_right_bottom',label:'홈 · 우측 중단 (지식·건강·기타)'},{key:'home|home_right_top',page:'home',section:'home_right_top',label:'홈 · 우측 하단 (자동차·웹툰·패션)'},
