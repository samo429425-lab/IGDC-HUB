...
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = ''+
      ...
      '@media(max-width:820px){#'+ROOT_ID+' .igdc-ma-modal{width:calc(100vw - 20px);height:calc(100vh - 20px);height:calc(100dvh - 20px);max-height:calc(100dvh - 20px);flex-direction:column}#'+ROOT_ID+' .igdc-ma-side{width:auto;flex:0 0 auto;max-height:190px;padding:14px;overflow:auto}#'+ROOT_ID+' .igdc-ma-body{min-height:0;overflow:hidden}#'+ROOT_ID+' .igdc-ma-content{min-height:0;overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain}#'+ROOT_ID+' .grid{grid-template-columns:1fr}#'+ROOT_ID+' .igdc-ma-member-head{display:none!important}#'+ROOT_ID+' .igdc-ma-member-row{min-width:0;grid-template-columns:1fr!important;gap:5px!important}#'+ROOT_ID+' .igdc-ma-review-head{display:none!important}#'+ROOT_ID+' .igdc-ma-review-row{min-width:0;grid-template-columns:1fr!important;gap:5px!important}#'+ROOT_ID+' th:nth-child(1),#'+ROOT_ID+' td:nth-child(1){display:none}}';
