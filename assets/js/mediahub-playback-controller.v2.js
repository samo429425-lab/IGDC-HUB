/*
 * IGDC / MARU MediaHub playback controller v4.1.1 V41 Windows control-lane + compact-panel + subtitle-language upgrade
...
(function (global, document) {
  ...
  var DESKTOP_SERVICE_COPY = {
    ko:{subtitleLanguage:'자막 언어 선택',liveVoice:'실시간 음성 번역',liveVoicePending:'실시간 음성 번역 서비스 준비 중입니다.',languageSelected:'자막 언어'},
    en:{subtitleLanguage:'Subtitle language',liveVoice:'Live voice translation',liveVoicePending:'Live voice translation service is being prepared.',languageSelected:'Subtitle language'},
    zh:{subtitleLanguage:'字幕语言',liveVoice:'实时语音翻译',liveVoicePending:'实时语音翻译服务准备中。',languageSelected:'字幕语言'},
    zht:{subtitleLanguage:'字幕語言',liveVoice:'即時語音翻譯',liveVoicePending:'即時語音翻譯服務準備中。',languageSelected:'字幕語言'},
    ja:{subtitleLanguage:'字幕言語',liveVoice:'リアルタイム音声翻訳',liveVoicePending:'リアルタイム音声翻訳サービスを準備中です。',languageSelected:'字幕言語'},
    es:{subtitleLanguage:'Idioma de subtítulos',liveVoice:'Traducción de voz en tiempo real',liveVoicePending:'El servicio de traducción de voz en tiempo real está en preparación.',languageSelected:'Idioma de subtítulos'},
    fr:{subtitleLanguage:'Langue des sous-titres',liveVoice:'Traduction vocale en direct',liveVoicePending:'Le service de traduction vocale en direct est en préparation.',languageSelected:'Langue des sous-titres'},
    de:{subtitleLanguage:'Untertitelsprache',liveVoice:'Live-Sprachübersetzung',liveVoicePending:'Der Dienst für Live-Sprachübersetzung wird vorbereitet.',languageSelected:'Untertitelsprache'},
    ru:{subtitleLanguage:'Язык субтитров',liveVoice:'Перевод речи в реальном времени',liveVoicePending:'Сервис перевода речи в реальном времени готовится.',languageSelected:'Язык субтитров'},
    pt:{subtitleLanguage:'Idioma das legendas',liveVoice:'Tradução de voz em tempo real',liveVoicePending:'O serviço de tradução de voz em tempo real está em preparação.',languageSelected:'Idioma das legendas'},
    it:{subtitleLanguage:'Lingua sottotitoli',liveVoice:'Traduzione vocale in tempo reale',liveVoicePending:'Il servizio di traduzione vocale in tempo reale è in preparazione.',languageSelected:'Lingua sottotitoli'},
    ar:{subtitleLanguage:'لغة الترجمة',liveVoice:'ترجمة صوتية فورية',liveVoicePending:'خدمة الترجمة الصوتية الفورية قيد الإعداد.',languageSelected:'لغة الترجمة'},
    vi:{subtitleLanguage:'Ngôn ngữ phụ đề',liveVoice:'Dịch giọng nói trực tiếp',liveVoicePending:'Dịch vụ dịch giọng nói trực tiếp đang được chuẩn bị.',languageSelected:'Ngôn ngữ phụ đề'},
    th:{subtitleLanguage:'ภาษาคำบรรยาย',liveVoice:'แปลเสียงแบบเรียลไทม์',liveVoicePending:'กำลังเตรียมบริการแปลเสียงแบบเรียลไทม์',languageSelected:'ภาษาคำบรรยาย'},
    id:{subtitleLanguage:'Bahasa subtitel',liveVoice:'Terjemahan suara langsung',liveVoicePending:'Layanan terjemahan suara langsung sedang disiapkan.',languageSelected:'Bahasa subtitel'},
    hi:{subtitleLanguage:'उपशीर्षक भाषा',liveVoice:'लाइव वॉइस अनुवाद',liveVoicePending:'लाइव वॉइस अनुवाद सेवा तैयार की जा रही है।',languageSelected:'उपशीर्षक भाषा'},
    tr:{subtitleLanguage:'Altyazı dili',liveVoice:'Canlı ses çevirisi',liveVoicePending:'Canlı ses çevirisi hizmeti hazırlanıyor.',languageSelected:'Altyazı dili'},
    fa:{subtitleLanguage:'زبان زیرنویس',liveVoice:'ترجمه زنده صوتی',liveVoicePending:'سرویس ترجمه زنده صوتی در حال آماده‌سازی است.',languageSelected:'زبان زیرنویس'},
    bn:{subtitleLanguage:'সাবটাইটেল ভাষা',liveVoice:'লাইভ ভয়েস অনুবাদ',liveVoicePending:'লাইভ ভয়েস অনুবাদ সেবা প্রস্তুত করা হচ্ছে।',languageSelected:'সাবটাইটেল ভাষা'},
    ur:{subtitleLanguage:'سب ٹائٹل زبان',liveVoice:'لائیو وائس ترجمہ',liveVoicePending:'لائیو وائس ترجمہ سروس تیار کی جا رہی ہے۔',languageSelected:'سب ٹائٹل زبان'},
    sw:{subtitleLanguage:'Lugha ya manukuu',liveVoice:'Tafsiri ya sauti mubashara',liveVoicePending:'Huduma ya tafsiri ya sauti mubashara inaandaliwa.',languageSelected:'Lugha ya manukuu'},
    ta:{subtitleLanguage:'வசன மொழி',liveVoice:'நேரடி குரல் மொழிபெயர்ப்பு',liveVoicePending:'நேரடி குரல் மொழிபெயர்ப்பு சேவை தயாராகிறது.',languageSelected:'வசன மொழி'},
    hu:{subtitleLanguage:'Felirat nyelve',liveVoice:'Élő hangfordítás',liveVoicePending:'Az élő hangfordítási szolgáltatás előkészítés alatt áll.',languageSelected:'Felirat nyelve'},
    ms:{subtitleLanguage:'Bahasa sari kata',liveVoice:'Terjemahan suara langsung',liveVoicePending:'Perkhidmatan terjemahan suara langsung sedang disediakan.',languageSelected:'Bahasa sari kata'},
    nl:{subtitleLanguage:'Ondertiteltaal',liveVoice:'Live spraakvertaling',liveVoicePending:'De live spraakvertaaldienst wordt voorbereid.',languageSelected:'Ondertiteltaal'},
    pl:{subtitleLanguage:'Język napisów',liveVoice:'Tłumaczenie głosu na żywo',liveVoicePending:'Usługa tłumaczenia głosu na żywo jest przygotowywana.',languageSelected:'Język napisów'},
    sv:{subtitleLanguage:'Undertextspråk',liveVoice:'Direkt röstöversättning',liveVoicePending:'Tjänsten för direkt röstöversättning förbereds.',languageSelected:'Undertextspråk'},
    tl:{subtitleLanguage:'Wika ng subtitle',liveVoice:'Live na pagsasalin ng boses',liveVoicePending:'Inihahanda ang live na serbisyo ng pagsasalin ng boses.',languageSelected:'Wika ng subtitle'},
    uk:{subtitleLanguage:'Мова субтитрів',liveVoice:'Переклад голосу наживо',liveVoicePending:'Сервіс перекладу голосу наживо готується.',languageSelected:'Мова субтитрів'},
    uz:{subtitleLanguage:'Subtitr tili',liveVoice:'Jonli ovoz tarjimasi',liveVoicePending:'Jonli ovoz tarjimasi xizmati tayyorlanmoqda.',languageSelected:'Subtitr tili'}
  };
  var SUBTITLE_LANGUAGES = [
    ['ko','한국어'],['en','English'],['zh','简体中文'],['zht','繁體中文'],['ja','日本語'],['es','Español'],['fr','Français'],['de','Deutsch'],['ru','Русский'],['pt','Português'],['it','Italiano'],['ar','العربية'],['vi','Tiếng Việt'],['th','ไทย'],['id','Bahasa Indonesia'],['hi','हिन्दी'],['tr','Türkçe'],['fa','فارسی'],['bn','বাংলা'],['ur','اردو'],['sw','Kiswahili'],['ta','தமிழ்'],['hu','Magyar'],['ms','Bahasa Melayu'],['nl','Nederlands'],['pl','Polski'],['sv','Svenska'],['tl','Filipino'],['uk','Українська'],['uz','Oʻzbekcha']
  ];
  function desktopServiceCopy(){
    var lang=String((document.documentElement&&document.documentElement.lang)||'ko').toLowerCase();
    if(lang==='zh-hant'||lang==='zh-tw'||lang==='zh-hk')lang='zht';
    lang=lang.split('-')[0];
    return DESKTOP_SERVICE_COPY[lang]||DESKTOP_SERVICE_COPY.en;
  }
  function defaultSubtitleTargetLang(){
    var lang=String((document.documentElement&&document.documentElement.lang)||'ko').toLowerCase();
    if(lang==='zh-hant'||lang==='zh-tw'||lang==='zh-hk')lang='zht';
    lang=lang.split('-')[0];
    return SUBTITLE_LANGUAGES.some(function(it){return it[0]===lang;})?lang:'en';
  }
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '@media(min-width:821px) and (pointer:fine){.igdc-maru-controls-row{right:14px;bottom:18px;gap:7px;min-height:46px;max-width:45%;align-items:center}.igdc-maru-controls-row .igdc-maru-icon-btn{width:44px;height:42px}.igdc-maru-controls-row .igdc-maru-text-btn{min-width:46px;height:42px;padding:0 10px;font-size:14px}.igdc-maru-controls-row .igdc-maru-icon-btn svg,.igdc-maru-controls-row .igdc-maru-text-btn svg{width:22px;height:22px}.igdc-maru-controls-row .igdc-maru-volume{min-width:124px}.igdc-maru-controls-row .igdc-maru-volume input{width:84px}.igdc-maru-panel{height:auto!important;min-height:0!important;max-height:min(520px,calc(100% - 150px))!important;overflow-y:auto!important}.igdc-maru-panel-section:last-child{padding-bottom:0!important}.igdc-maru-subtitle-language{display:grid;grid-template-columns:1fr;gap:7px}.igdc-maru-subtitle-language select{width:100%;height:38px;padding:0 10px;border:1px solid rgba(255,255,255,.13);border-radius:9px;background:#20262e;color:#eef3f8;font:600 12.5px/1 system-ui;outline:none}.igdc-maru-subtitle-language select:focus{border-color:rgba(97,169,255,.7);box-shadow:0 0 0 2px rgba(97,169,255,.12)}}',
      '.igdc-desktop-player .igdc-maru-controls-row{width:max-content;max-width:min(49%,780px);overflow-x:auto;overflow-y:hidden;padding-left:2px}.igdc-desktop-player .igdc-transport-overlay{transform-origin:center center}.igdc-desktop-player .igdc-maru-panel{top:auto!important;bottom:126px!important;height:auto!important;min-height:0!important;max-height:calc(100% - 190px)!important;overflow-x:hidden!important}.igdc-desktop-player .igdc-maru-panel[data-panel=\"subtitle\"]{width:min(390px,calc(100vw - 24px))}.igdc-desktop-player .igdc-maru-panel-section:last-child{padding-bottom:0!important;margin-bottom:0!important}',
  ...
  function saveFrameFromVideo(video,e) {
    var canvas=document.createElement('canvas'),ctx=canvas.getContext('2d',{alpha:false});
  ...
  function retryFrameWithCors(video,e) {
    var source='';try{source=video.currentSrc||video.src||'';}catch(_src){}
    if(!source){showNotice(e.shotUnsupported);return;}
    var probe=document.createElement('video'),done=false,timer=0;
    function finish(ok){if(done)return;done=true;clearTimeout(timer);try{probe.pause();probe.removeAttribute('src');probe.load();}catch(_clean){}if(!ok)showNotice(e.shotUnsupported);}
    probe.crossOrigin='anonymous';probe.muted=true;probe.playsInline=true;probe.preload='auto';
    probe.addEventListener('error',function(){finish(false);},{once:true});
    probe.addEventListener('loadedmetadata',function(){try{var t=Math.max(0,Math.min(Number(video.currentTime)||0,Number.isFinite(probe.duration)?Math.max(0,probe.duration-.05):Number(video.currentTime)||0));probe.currentTime=t;}catch(_seek){finish(false);}},{once:true});
    probe.addEventListener('seeked',function(){try{saveFrameFromVideo(probe,e);finish(true);}catch(_draw){finish(false);}},{once:true});
    timer=setTimeout(function(){finish(false);},6500);
    try{probe.src=source;probe.load();}catch(_load){finish(false);}
  }
  function captureFrame() {
    var e=extraCopy(),video=currentVideo();
    if(!video||!video.videoWidth||!video.videoHeight){showNotice(e.shotUnsupported);return;}
    try { saveFrameFromVideo(video,e); }
    catch(err){ retryFrameWithCors(video,e); }
  }
  ...
  function positionDesktopTransport() {
    ...
    try{
      ...
      var db=state.detail.getBoundingClientRect(),tb=transport.getBoundingClientRect(),rb=controls.getBoundingClientRect();
      if(!db.width||!tb.width)return;
      var rightStart=rb.left;
      var visible=controls.querySelectorAll('button,label,input');
      Array.prototype.forEach.call(visible,function(node){
        if(!node||node.closest('.igdc-maru-spacer'))return;
      ...
      var gap=Math.max(34,Math.min(54,db.width*.026));
      var leftPad=Math.max(18,Math.min(34,db.width*.016));
      var available=Math.max(1,rightStart-gap-(db.left+leftPad));
      var scale=Math.min(1,available/tb.width);
      if(scale<0.55)scale=0.55;
      var half=(tb.width*scale)/2;
      var minCenter=db.left+leftPad+half;
      var maxCenter=rightStart-gap-half;
      if(maxCenter<minCenter){
        var exact=Math.max(0.42,Math.min(scale,available/tb.width));
        scale=exact;half=(tb.width*scale)/2;
        minCenter=db.left+leftPad+half;
        maxCenter=rightStart-gap-half;
      }
      var desired=db.left+(db.width*.50);
      ...
      transport.dataset.desktopSafeLane='true';
    }catch(_pos){}
  }

  function fitDesktopPanel() {
    if(!state.detail||isMobileUiMode())return;
    var panel=state.detail.querySelector('.igdc-maru-panel');
    if(!panel||panel.hidden)return;
    try{
      panel.style.setProperty('top','auto','important');
      panel.style.setProperty('bottom','126px','important');
      panel.style.setProperty('height','auto','important');
      panel.style.setProperty('min-height','0','important');
      panel.style.setProperty('max-height','none','important');
      panel.style.setProperty('overflow-y','visible','important');
      var db=state.detail.getBoundingClientRect();
      var available=Math.max(180,Math.floor(db.height-196));
      var natural=Math.max(1,Math.ceil(panel.scrollHeight+2));
      var fitted=Math.min(natural,available);
      panel.style.setProperty('height',fitted+'px','important');
      panel.style.setProperty('max-height',available+'px','important');
      panel.style.setProperty('overflow-y',natural>available?'auto':'hidden','important');
    }catch(_panelFit){}
  }
  ...
  function bindDesktopLayoutObserver() {
    ...
    try{
      ...
      state.desktopLayoutObserver=new global.ResizeObserver(function(){positionDesktopTransport();fitDesktopPanel();});
    ...
    }catch(_layoutObserver){state.desktopLayoutObserver=null;}
  }
  ...
  function openPanel(name) {
    ...
    state.panel=name||'tools';panel.hidden=false;panel.dataset.panel=state.panel;renderPanel();fitDesktopPanel();showChrome(10000);
  }
  ...
  function renderPanel() {
    ...
    if(name==='view'){
      ...
      var svc=desktopServiceCopy();
      if(!isMobilePlaybackDevice()){
        var langSec=section(svc.subtitleLanguage),wrap=create('div','igdc-maru-subtitle-language'),sel=document.createElement('select');
        sel.dataset.mediaSubtitleLanguage='1';
        sel.setAttribute('aria-label',svc.subtitleLanguage);
        var selected=state.subtitleTargetLang||defaultSubtitleTargetLang();
        SUBTITLE_LANGUAGES.forEach(function(item){var opt=document.createElement('option');opt.value=item[0];opt.textContent=item[1];if(item[0]===selected)opt.selected=true;sel.appendChild(opt);});
        wrap.appendChild(sel);langSec.appendChild(wrap);
      }
      var subtitleItems=[{label:captionsEnabled()?c.captionsOff:c.captionsOn,action:'captions'},{label:c.translate,action:'translate'}];
      if(!isMobilePlaybackDevice())subtitleItems.push({label:svc.liveVoice,action:'live-voice-translate'});
      var s3=section(e.subtitle);grid(s3,subtitleItems);
      ...
      if(isMobilePlaybackDevice()){
        ...
        var desktopView=section(e.view);grid(desktopView,[{label:e.fit,action:'fit-contain'},{label:e.fill,action:'fit-cover'},{label:e.pip,action:'pip'},{label:isPlayerFullscreen()?c.exitFullscreen:c.fullscreen,action:'fullscreen'}]);
        var desktopPlayback=section(e.playback);grid(desktopPlayback,[{label:e.speed,action:'speed'},{label:e.loopOn,action:'loop'},{label:e.audio,action:'audio'},{label:e.subtitleTrack,action:'subtitle-panel'}]);
        var shotSec=section(e.tools);grid(shotSec,[{label:e.shot,action:'shot'}]);
  ...
  function open(card,options){options=options||{};if(!card)return;if(state.open){switchCard(card);return;}injectStyle();var mobileMode=isMobilePlaybackDevice();if(!mobileMode)attemptNativePlayer(card);state.open=true;state.mobileSession=mobileMode;state.mobileViewMode=mobileMode?'inline':'list';state.card=card;state.scrollY=global.scrollY||global.pageYOffset||0;state.panel='';state.subtitleTargetLang=state.subtitleTargetLang||defaultSubtitleTargetLang();state.playRequested=!!options.autoPlay||mobileMode;state.mobileFullscreenIntent=false;state.mobileImmersiveActive=false;if(state.fullscreenBodyOverflow===null)state.fullscreenBodyOverflow=document.body.style.overflow||'';hideList(card);var shell=buildPlayerShell(card);state.detail=shell.detail;state.stage=shell.stage;if(!mobileMode)state.detail.classList.add('igdc-desktop-player');document.body.appendChild(shell.detail);if(mobileMode)setMobileViewMode('immersive');else normalizePlayerGeometry();appendPlayer(state.stage,card);observeStage();normalizePlayerGeometry();if(!mobileMode){bindDesktopLayoutObserver();positionDesktopTransport();}if(mobileMode&&state.mobileViewMode==='immersive')applyMobileImmersiveGeometry(true);
    ...
    state.detail.addEventListener('change',function(event){var langSel=event.target&&event.target.closest&&event.target.closest('[data-media-subtitle-language]');if(!langSel)return;state.subtitleTargetLang=String(langSel.value||defaultSubtitleTargetLang());showNotice(desktopServiceCopy().languageSelected+': '+(langSel.options[langSel.selectedIndex]?langSel.options[langSel.selectedIndex].textContent:state.subtitleTargetLang),2200);fitDesktopPanel();});
  ...
  global.addEventListener('resize',function(){scheduleViewportRepair();positionDesktopTransport();fitDesktopPanel();},{passive:true});
  ...
  global.__IGDC_MEDIAHUB_PLAYER_VERSION__='4.1.1-v41-windows-control-lane-compact-panel-subtitle';
  global.IGDCMediaHubPlayback={open:open,close:close,previous:function(){move(-1);},next:function(){move(1);},captureFrame:captureFrame,captureClip:captureClip,VERSION:'4.1.1-v41-windows-control-lane-compact-panel-subtitle'};
})(window, document);
