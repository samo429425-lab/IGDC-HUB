...
(function (global, document) {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '@media(min-width:821px) and (pointer:fine){.igdc-maru-panel{right:18px;width:min(388px,calc(100vw - 36px));border-radius:13px;padding:14px 14px 16px;scrollbar-gutter:stable;box-shadow:0 18px 52px rgba(0,0,0,.48)}.igdc-maru-panel-title{font-size:15px;margin-bottom:12px}.igdc-maru-panel-grid{gap:8px}.igdc-maru-panel-grid button{height:40px}.igdc-maru-controls-row{right:16px;bottom:12px;gap:8px;max-width:60%;overflow-x:auto}.igdc-maru-controlbar{padding-left:14px;padding-right:14px;padding-bottom:12px}}',
  ...
  function positionDesktopPanelSafely() {
    ...
    var safeTop=Math.max(66, Math.round((topRect?topRect.bottom:detailRect.top+54)-detailRect.top+12));
  ...
  global.__IGDC_MEDIAHUB_PLAYER_VERSION__='4.0.1-v42r-v40-mobile-preserved-desktop-safe-lane';
  global.IGDCMediaHubPlayback={open:open,close:close,previous:function(){move(-1);},next:function(){move(1);},captureFrame:captureFrame,captureClip:captureClip,VERSION:'4.0.1-v42r-v40-mobile-preserved-desktop-safe-lane'};
})(window, document);
