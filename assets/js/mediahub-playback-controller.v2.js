/*
 * IGDC / MARU MediaHub playback controller v2.9.1 transport inside bottom bar
...
(function (global, document) {
  ...
  global.__IGDC_MEDIAHUB_PLAYER_VERSION__='2.9.1-transport-inside-bottombar';
  global.IGDCMediaHubPlayback={open:open,close:close,previous:function(){move(-1);},next:function(){move(1);},captureFrame:captureFrame,captureClip:captureClip,VERSION:'2.9.1-transport-inside-bottombar'};
})(window, document);
