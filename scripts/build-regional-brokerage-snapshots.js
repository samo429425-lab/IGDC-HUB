...
const SOCIAL_CHECKPOINT_TARGETS = [
  // Social publication now writes the ordinary SearchBank snapshot before the
  // existing Snapshot Engine consumes it.  These mirrors must be rolled back
  // together if the Social final publication fails.
